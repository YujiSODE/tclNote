	...
	proc run {} {
		...
		#****** Events ******
			...
			.unicodeSeq.tableB configure -command {
				...
				grid [ttk::label .uTable.cbBoxLbl -text {Block}] -column 0 -row 2 -sticky ew -padx 5 -pady 2;
